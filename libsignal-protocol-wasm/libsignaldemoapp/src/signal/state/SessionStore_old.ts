...
export interface SessionStore_old {
   ...
   */
   loadSession(remoteAddress: SignalProtocolAddress): Promise<SessionRecord | null> 
   ...
   */
  storeSession(address: SignalProtocolAddress, record: SessionRecord): Promise<void>;
