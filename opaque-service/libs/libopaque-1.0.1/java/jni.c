...
static const char *JNIT_CLASS = "com/algomeet/opaqueservice/jni/Opaque";
...
static void getids(JNIEnv *env, jobject ids_, Opaque_Ids *ids, IdGC *gc) {
    ...
    cls = (*env)->FindClass(env, "com/algomeet/opaqueservice/jni/dto/OpaqueIds");
...
static jobject c_register(JNIEnv *env, jobject obj, jstring pwd_, jbyteArray skS_, jobject ids_) {
  ...
  return retlist(env, "com/algomeet/opaqueservice/jni/dto/OpaqueRecExpKey", ret);
}
...
static jobject c_createCredReq(JNIEnv *env, jobject obj, jstring pwd_) {
  ...
  return retlist(env, "com/algomeet/opaqueservice/jni/dto/OpaqueCredReq", ret);
}
...
static jobject c_createCredResp(JNIEnv *env, jobject obj, jbyteArray pub_, jbyteArray rec_, jobject ids_, jstring context_) {
  ...
  return retlist(env, "com/algomeet/opaqueservice/jni/dto/OpaqueCredResp", ret);
}
...
static jobject c_recoverCredentials(JNIEnv *env, jobject obj, jbyteArray resp_, jbyteArray sec_, jstring context_, jobject ids_) {
  ...
  jobject ret = retlist(env, "com/algomeet/opaqueservice/jni/dto/OpaqueCreds", retvals);
  jclass clazz = (*env)->FindClass(env, "com/algomeet/opaqueservice/jni/dto/OpaqueCreds");
...
// uint8_t sec[OPAQUE_REGISTER_USER_SEC_LEN+pwdU_len], uint8_t M[crypto_core_ristretto255_BYTES]);
  ...
  return retlist(env, "com/algomeet/opaqueservice/jni/dto/OpaqueRegReq", ret);
}
...
static jobject c_createRegResp(JNIEnv *env, jobject obj, jbyteArray M_, jbyteArray sks_) {
  ...
  return retlist(env, "com/algomeet/opaqueservice/jni/dto/OpaqueRegResp", ret);
}
...
static jobject c_finalizeReg(JNIEnv *env, jobject obj, jbyteArray sec_, jbyteArray pub_, jobject ids_) {
  ...
  return retlist(env, "com/algomeet/opaqueservice/jni/dto/OpaquePreRecExpKey", ret);
}
...
static JNINativeMethod funcs[] = {
  { "c_register", "(Ljava/lang/String;[BLcom/algomeet/opaqueservice/jni/dto/OpaqueIds;)Lcom/algomeet/opaqueservice/jni/dto/OpaqueRecExpKey;", (void *)&c_register },
  { "c_register", "(Ljava/lang/String;[B)Lcom/algomeet/opaqueservice/jni/dto/OpaqueRecExpKey;", (void *)&c_register_noIds },
  { "c_register", "(Ljava/lang/String;Lcom/algomeet/opaqueservice/jni/dto/OpaqueIds;)Lcom/algomeet/opaqueservice/jni/dto/OpaqueRecExpKey;", (void *)&c_register_noSks },
  { "c_register", "(Ljava/lang/String;)Lcom/algomeet/opaqueservice/jni/dto/OpaqueRecExpKey;", (void *)&c_register1 },
  { "c_createCredReq", "(Ljava/lang/String;)Lcom/algomeet/opaqueservice/jni/dto/OpaqueCredReq;", (void *)&c_createCredReq },
  { "c_createCredResp", "([B[BLcom/algomeet/opaqueservice/jni/dto/OpaqueIds;Ljava/lang/String;)Lcom/algomeet/opaqueservice/jni/dto/OpaqueCredResp;", (void *)&c_createCredResp },
  { "c_recoverCreds", "([B[BLjava/lang/String;Lcom/algomeet/opaqueservice/jni/dto/OpaqueIds;)Lcom/algomeet/opaqueservice/jni/dto/OpaqueCreds;", (void *)&c_recoverCredentials },
  { "c_userAuth", "([B[B)Z", (void *)&c_userAuth },
  { "c_createRegReq", "(Ljava/lang/String;)Lcom/algomeet/opaqueservice/jni/dto/OpaqueRegReq;", (void *)&c_createRegReq },
  { "c_createRegResp", "([B[B)Lcom/algomeet/opaqueservice/jni/dto/OpaqueRegResp;", (void *)&c_createRegResp},
  { "c_createRegResp", "([B)Lcom/algomeet/opaqueservice/jni/dto/OpaqueRegResp;", (void *)&c_createRegResp1},
  { "c_finalizeReg", "([B[BLcom/algomeet/opaqueservice/jni/dto/OpaqueIds;)Lcom/algomeet/opaqueservice/jni/dto/OpaquePreRecExpKey;", (void *)&c_finalizeReg },
