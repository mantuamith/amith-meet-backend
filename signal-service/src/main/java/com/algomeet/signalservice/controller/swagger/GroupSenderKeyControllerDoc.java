...
public interface GroupSenderKeyControllerDoc {
     ...
     */
    @Operation(
        summary = "Delete Sender Keys",
        description = "Delete all sender keys matching sender user, sender device, group."
    )
    @ApiResponse(
        responseCode = "200",
    ...
    public ResponseEntity<CommonResponse<List<GroupSenderKeyResponse>>> delete(
            ...
            @Parameter(description = "Sender user key", required = true)
