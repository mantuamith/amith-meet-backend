...
public class ExampleAliceToBobWeb {	
	...
	DuplicateMessageException, InvalidKeyIdException {
		...
		PreKeyBundle bobPreKeyBundle= new PreKeyBundle(8507, 
				bobDeviceId,
				bobPreKeyId, 
				new ECPublicKey(Base64.getDecoder().decode("BQSSrO+ptoMyFfuO+O1Bw5jEzfVOXjBlapE179yXKsUw")),
				bobSignedPreKeyId, 
				new ECPublicKey(Base64.getDecoder().decode("Bbl7iLXs5EiPppFL9+7cFuoVZ8GxDbfLDBiWUW/JilVf")),
				Base64.getDecoder().decode("vizVtNlMWLZ8cG5BEEoS4Ky14wibuFgS7oNnivZ4hb7VOBTluC0seCgcNSIkiFg5tvtigxNspljnakVrDtFDhQ=="),
				//bobStore.getIdentityKeyPair().getPublicKey(),
				new IdentityKey(Base64.getDecoder().decode("BYNRxhi2pfBeo+gDVKqwQkFjQLxC7a6mQL2nphGDw+BN")),
				bobKyberPreKeyId,
