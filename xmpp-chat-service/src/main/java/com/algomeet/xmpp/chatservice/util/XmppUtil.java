...
public class XmppUtil {
	...
	public static String getResourceFromRoomFullJid(String roomfullJid) {
		if(!StringUtils.hasText(roomfullJid)) {
			return null;
		}

		String temp[] = roomfullJid.trim().split(BARE_JID_SEPARATOR, 2);
		if (temp.length < 2) {
			return null;
		}
